...
class Parser():
    def __init__(self):
        ...
        self.parser.add_argument('-c', '-n', '--n', '-np', dest='procs', type=int, help='Number of processes to launch')
        self.parser.add_argument('--map-by', default='node', type=str, help='Mapping of processes.')
        ...
        self.parser.add_argument('-rank-by', default='slot', choices=['slot', 'core', 'node']
